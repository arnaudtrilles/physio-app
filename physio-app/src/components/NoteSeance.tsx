...
export const NoteSeance = forwardRef<NoteSeanceHandle, { initialData?: NoteSeanceData }>(
  ({ initialData }, ref) => {
    ...
    const sections = [
      { id: 'subjective', title: 'S — Ressenti / Suivi', color: 'var(--accent)' },
      { id: 'objective',  title: 'O — Traitement du jour', color: 'var(--color-emerald)' },
      { id: 'assessment', title: 'A — Réaction', color: 'var(--color-warning)' },
      { id: 'plan',       title: 'P — Prochaine étape', color: 'var(--color-purple)' },
    ]
                  ...
                  <>
                    ...
                    <div style={{ marginBottom: 12 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        ...
                        <span style={{ fontWeight: 700, fontSize: '1.1rem', color: 'var(--accent)', minWidth: 28, textAlign: 'center' }}>
                          {eva || '—'}
                        </span>
                      </div>
                    </div>
