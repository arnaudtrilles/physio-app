  ...
  return (
    <div>
      {[
        ...
        { id: 'redFlags', title: 'Red Flags + Syndrome queue de cheval', color: 'var(--color-danger)' },
                ...
                <>
                  {hasCaudaEquina && (
                    <div style={{ background: 'var(--color-danger-bg)', border: '1px solid var(--color-danger-border)', borderRadius: 10, padding: 12, marginBottom: 12 }}>
                      ...
                      <p style={{ fontSize: '0.8rem', color: 'var(--color-danger-deeper)', margin: 0 }}>Orientation en urgence aux urgences chirurgicales. IRM immédiate.</p>
                    </div>
                  )}
                  {[
