...
export const BilanGenerique = forwardRef<BilanGeneriqueHandle, { initialData?: Record<string, unknown> }>(({ initialData }, ref) => {
  ...
  return (
    <div>
      <div style={{ background: 'var(--color-info-bg)', border: '1px solid var(--color-info-border)', borderRadius: 12, padding: 14, marginBottom: 16 }}>
        <p style={{ fontSize: '0.82rem', color: 'var(--color-info)', margin: 0, fontWeight: 600 }}>
          Bilan générique — Zone non spécialisée
        </p>
        <p style={{ fontSize: '0.78rem', color: 'var(--primary-light)', margin: '4px 0 0' }}>
      ...
      <div style={{ marginBottom: 16 }}>
        <div style={{ fontWeight: 700, color: 'var(--color-danger)', marginBottom: 8, fontSize: '0.95rem' }}>Red Flags</div>
