  ...
  return (
    <div>
      {[
        ...
        { id: 'cinqD3N', title: '5D 3N — Risque artère vertébrale', color: 'var(--color-danger)' },
        { id: 'redFlags', title: 'Red Flags', color: 'var(--color-danger)' },
        { id: 'yellowFlags', title: 'Yellow Flags', color: 'var(--color-warning)' },
        { id: 'blueBlackFlags', title: 'Blue / Black Flags', color: 'var(--color-purple)' },
        ...
        { id: 'contrat', title: 'Contrat kiné', color: 'var(--color-emerald)' },
      ].map(sec => (
          ...
          {open[sec.id] && (
            <div style={{ paddingTop: 12, paddingBottom: 8 }}>
              ...
              {sec.id === 'cinqD3N' && (
                <>
                  {has5D3N && (
                    <div style={{ background: 'var(--color-danger-bg)', border: '1px solid var(--color-danger-border)', borderRadius: 10, padding: 12, marginBottom: 12 }}>
                      <div style={{ fontWeight: 700, color: 'var(--color-danger-dark)', fontSize: '0.88rem', marginBottom: 4 }}>
                        Attention — Risque artère vertébrale
                      </div>
                      <p style={{ fontSize: '0.8rem', color: 'var(--color-danger-deeper)', margin: 0 }}>Un ou plusieurs signes 5D 3N positifs. Contre-indication aux techniques de haute vélocité sur la colonne cervicale.</p>
                    </div>
                  )}
                  {[
