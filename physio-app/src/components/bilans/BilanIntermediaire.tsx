...
>(({ bilanType, initialData }, ref) => {
  ...
  const sections = [
    ...
    { id: 'evolutionDouleur', title: 'Évolution de la douleur',         color: 'var(--color-danger)' },
    { id: 'vigilanceFlags',   title: 'Vigilance & Drapeaux (Flags)',    color: 'var(--color-warning)' },
    { id: 'suiviTraitement',  title: 'Suivi du traitement et observance', color: 'var(--color-purple)' },
    { id: 'moduleSpecifique', title: `Module spécifique : ${sectionLabel[bilanType]}`, color: 'var(--primary)' },
    { id: 'synthese',         title: 'Synthèse et objectifs',           color: 'var(--color-emerald)' },
  ]
            ...
            <div style={{ paddingTop: 12, paddingBottom: 8 }}>
              ...
              {sec.id === 'vigilanceFlags' && (
                <>
                  ...
                  {redFlagNouv === 'oui' && (
                    <div style={{ background: 'var(--color-danger-bg)', border: '1px solid var(--pain-critical)', borderRadius: 8, padding: '0.75rem', marginTop: 4, marginBottom: 10 }}>
                      <div style={{ fontSize: '0.75rem', fontWeight: 600, color: 'var(--color-danger-dark)', marginBottom: 8 }}>Préciser les nouveaux red flags :</div>
                      {[
                ...
                <>
                  ...
                  {tolerance !== '' && tolerance !== 'Excellente' && (
                    <textarea value={toleranceDetail} onChange={e => setToleranceDetail(e.target.value)}
                      ...
                      style={{ width: '100%', padding: '0.5rem 0.7rem', fontSize: '0.82rem', color: 'var(--text-main)', background: 'var(--color-warning-bg)', border: '1px solid var(--color-warning-border)', borderRadius: 8, resize: 'vertical', marginBottom: 10, boxSizing: 'border-box' }} />
                  )}
