      ...
      >
        ...
        <div style={{ overflowY: 'auto', flex: 1, padding: '0 20px 20px' }}>
          ...
          {currentMarkdown && (
            ...
            >
              <div style={{ fontSize: '0.88rem', fontWeight: 700, color: 'var(--color-emerald-deeper)', marginBottom: 12 }}>
                ...
                {ZONES.map(z => (
                  <button
                    ...
                    style={{
                      ...
                      border: 'none',
                      cursor: 'pointer',
                      background: zone === z ? 'var(--color-emerald)' : 'var(--color-teal-light)',
                      color: zone === z ? '#fff' : 'var(--color-emerald-deeper)',
              ...
              <button
                ...
                style={{
                  ...
                  width: '100%',
                  padding: '10px 0',
                  background: name.trim() ? 'var(--color-emerald)' : 'var(--color-emerald-light)',
                  color: '#fff',
                  border: 'none',
                  borderRadius: 'var(--radius-md)',
                  fontSize: '0.88rem',
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, margin: '14px 0 10px' }}>
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  cursor: 'pointer',
                  background: filterZone === null ? 'var(--color-emerald)' : 'var(--secondary)',
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: 'none',
                      cursor: 'pointer',
                      background: filterZone === z ? 'var(--color-emerald)' : 'var(--secondary)',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                    ...
                    <span
                      style={{
                        ...
                        color: 'var(--color-emerald-deeper)',
                        whiteSpace: 'nowrap',
                      }}
                    >
                      {t.zone}
