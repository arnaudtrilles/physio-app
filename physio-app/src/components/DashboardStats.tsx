  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: '1.25rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 10 }}>
        <StatCard label="Patients actifs" value={patientsActifs} color="var(--primary)" iconType="user" />
        <StatCard label="Bilans réalisés" value={bilansComplets} color="var(--primary)" iconType="clipboard" />
        <StatCard
          ...
          iconType="trending"
        />
        <StatCard label="Séances notées" value={seancesNotees} color="var(--color-purple-dark)" iconType="calendar" />
      </div>
