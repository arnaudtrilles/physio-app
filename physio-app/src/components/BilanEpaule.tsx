...
export const BilanEpaule = forwardRef<BilanEpauleHandle, { initialData?: Record<string, unknown> }>(({ initialData }, ref) => {
  ...
  // ── Contrat Kiné ──
  const [objectifsSMART, setObjectifsSMART]   = useState((_ck.objectifsSMART as string) ?? '')
  ...
  useImperativeHandle(ref, () => ({
    ...
    setData: (data: Record<string, unknown>) => {
      ...
      if (ckD.objectifsSMART !== undefined)  setObjectifsSMART(ckD.objectifsSMART as string)
            ...
            <div style={{ paddingTop: 12, paddingBottom: 8 }}>
              ...
              {sec.id === 'contrat' && (
                <>
                  ...
                  <textarea value={objectifsSMART} onChange={e => setObjectifsSMART(e.target.value)}
                    placeholder="Spécifique, Mesurable, Atteignable, Réaliste, Temporel…" rows={3} style={{ ...inputStyle, resize: 'vertical' }} />
