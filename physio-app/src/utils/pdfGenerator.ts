...
// ── Couleurs ──────────────────────────────────────────────────────────────────
const C = {
  primary: [30, 58, 138] as [number, number, number],     // var(--primary)
  primaryLight: [239, 246, 255] as [number, number, number], // var(--color-info-bg)
  accent: [5, 150, 105] as [number, number, number],      // var(--color-emerald)
  text: [31, 41, 55] as [number, number, number],          // var(--color-gray-dark)
  muted: [107, 114, 128] as [number, number, number],      // var(--color-gray-mid)
  light: [229, 231, 235] as [number, number, number],      // var(--color-gray-border)
