...
21. RÉDACTION À LA 1ʳᵉ PERSONNE — Le bilan est rédigé à la **première personne du singulier du point de vue du ${titreRole}** (« Je note », « J'observe », « À l'examen je retrouve », « Je propose », « Je retiens », « Je conclus »). Le patient reste à la **3ᵉ personne** (« le patient » / « la patiente »). INTERDIT : « le thérapeute », « le ${titreRole} » désignant l'auteur, « l'examinateur », « on retrouve », tournures passives qui masquent l'auteur (« il a été noté », « il est retrouvé », « il convient de signaler »). Cohérence stricte sur tout le document — aucune alternance.
