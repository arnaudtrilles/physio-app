        ...
        <div style={{ display: 'flex', gap: 4, flexShrink: 0 }}>
          <button
            ...
            style={{
              ...
              background: parsed.status === '+' ? '#fee2e2' : 'var(--input-bg)',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 10, cursor: 'pointer',
              background: parsed.status === '-' ? '#dcfce7' : 'var(--input-bg)',
              ...
              <div style={{ display: 'flex', gap: 4, flexShrink: 0 }}>
                <button
                  ...
                  style={{
                    ...
                    background: v === '+' ? '#fee2e2' : 'var(--input-bg)',
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 8, cursor: 'pointer',
                    background: v === '-' ? '#dcfce7' : 'var(--input-bg)',
