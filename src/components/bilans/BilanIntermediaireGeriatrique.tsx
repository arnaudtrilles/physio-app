...
export const BilanIntermediaireGeriatrique = forwardRef<BilanIntermediaireGeriatriqueHandle, { baseline?: Record<string, unknown>; initialData?: Record<string, unknown> }>(({ baseline, initialData }, ref) => {
  ...
  const inputStyle: React.CSSProperties = { width: '100%', padding: '0.6rem 0.85rem', fontSize: '0.88rem', color: 'var(--text-main)', background: 'var(--secondary)', border: '1px solid transparent', borderRadius: 'var(--radius-md)', boxSizing: 'border-box' }
