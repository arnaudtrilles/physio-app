  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ overflowY: 'auto', padding: '0.5rem 1.2rem', paddingBottom: 'max(1.2rem, env(safe-area-inset-bottom))', flex: 1, minHeight: 0, WebkitOverflowScrolling: 'touch', overscrollBehavior: 'contain' }}>{children}</div>
