...
export const colors = {
  // Brand — suit le thème via CSS vars
  primary: 'var(--primary)',
  primaryDark: 'var(--primary-dark)',
  primaryLight: 'var(--primary-light)',
  accent: 'var(--accent)',

  // Surfaces — suit le thème
  surface: 'var(--surface)',
  ...
  // Semantic — fixes, ne changent pas entre thèmes
  success: '#166534',
  successBg: '#dcfce7',
  successSoft: '#f0fdf4',
  warning: '#d97706',
...
export const shadow = {
  ...
  primaryStrong: 'var(--primary-shadow-strong)',
} as const
